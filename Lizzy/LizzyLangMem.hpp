...
namespace Lizzy
{
	...
	protected:
		...
		_decl_action(new_const_action)
		_decl_action(new_const_Integer_action)
		_decl_action(new_const_Float_action)
		_decl_action(new_const_Bool_action)
		_decl_action(new_const_String_action)
